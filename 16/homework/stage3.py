...
def play_in_turn():
    ...
    if quantity_rounds in command_list and quantity_rounds == '':
        rounds = 3
    elif quantity_rounds in command_list and quantity_rounds == "exit":
        sys.exit("Good luck!))")
    elif quantity_rounds not in command_list:
        print("Impossible value for quantity of rounds")
        return 0
